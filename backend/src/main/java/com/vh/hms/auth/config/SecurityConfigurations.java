    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/patient/{patient}").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/doctors/list/{specialization}").hasRole("PATIENT")
                        .requestMatchers(HttpMethod.GET,"/my").hasAnyRole("PATIENT", "DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/appointments").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH,"/appointments/finish").authenticated()
